                              ...
                              <li key={item.name}>
                                <a
                                  ...
                                  className={classNames(
                                    item.current
                                      ? "bg-gray-50 text-c-orange-600"
                                      : "text-gray-700 hover:text-c-orange-600 hover:bg-gray-50",
                                ...
                                >
                                  <item.icon
                                    className={classNames(
                                      item.current
                                        ? "text-c-orange-600"
                                        : "text-gray-400 group-hover:text-c-orange-600",
                                      "h-6 w-6 shrink-0"
                                    )}
                                    aria-hidden="true"
                                  />
            ...
            <nav className="flex flex-1 flex-col">
              <ul role="list" className="flex flex-1 flex-col gap-y-7">
                ...
                <Menu as="div" className="relative -mx-6 mt-auto">
                  <Menu.Button className=" flex items-center px-6 py-3 text-sm f font-semibold leading-6 text-gray-900 hover:bg-gray-50">
