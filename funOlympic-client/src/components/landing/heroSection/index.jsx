        ...
        <div className="mx-auto max-w-7xl px-6 py-32 sm:py-40 lg:px-8">
          <div className="mx-auto max-w-2xl lg:mx-0 lg:grid lg:max-w-none lg:grid-cols-2 lg:gap-x-16 lg:gap-y-6 xl:grid-cols-1 xl:grid-rows-1 xl:gap-x-8">
            ...
            <div className="mt-6 max-w-xl lg:mt-0 xl:col-end-1 xl:row-start-1">
              <p class="text-lg leading-8 text-gray-600 mt-40">
                Experience the thrill of Fun Olympics 2024 in the vibrant city of Paris! Join us for an unforgettable celebration of sportsmanship and achievement against the backdrop of iconic landmarks. Get ready to witness history in the making!
              </p>
              &nbsp;
              <p className="text-lg leading-8 text-gray-600">
                ULTIMATE STAGE TO PARIS: THE OLYMPIC SERIES IS COMING!
              </p>
              <div className="mt-10 flex items-center gap-x-6">
                ...
                <a href="live-events" className="text-sm font-semibold leading-6 text-gray-900">
                  See Live Events <span aria-hidden="true">→</span>
                </a>
              </div>
            </div>
            <img
              src="https://wallpaperswide.com/download/2024_summer_olympics-wallpaper-3840x3840.jpg"
              alt=""
